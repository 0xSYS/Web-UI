 ...
 function DialogBox(id, callback) {
	...
	var	_minW = 100, // The exact value get's calculated
		...
		_init = function(id, callback) {
			...
			_buttons = _dialog.getElementsByClassName('dlgButton');  // Ensure to get minimal width
    ...
    var dialogSample
    function showDialogSample()
    {
        if(!dialogSample) dialogSample = new DialogBox("dlgSample");
        dialogSample.showDialog();
    }